        ...
        <div class="text-center mb-4">
            ...
            <div class="container text-start row">
                ...
                <div class="mb-4 d-flex justify-content-center">
                    <a href="<?= BASE_URL ?>" class="btn btn-outline-primary d-flex justify-content-center align-items-center w-100">
            ...
            <span>Don't have an account? <a href="register" class="link-primary link-offset-2 link-underline-opacity-0 link-underline-opacity-100-hover">Sign up</a></span>
        </div>
    </div>
</div>
